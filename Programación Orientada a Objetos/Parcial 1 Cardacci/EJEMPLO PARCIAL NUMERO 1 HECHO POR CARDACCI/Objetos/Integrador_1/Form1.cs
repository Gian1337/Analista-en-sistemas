...
namespace Integrador_1
{
    public partial class Form1 : Form
    {
        ...
        private void dataGridView1_RowEnter(object sender, DataGridViewCellEventArgs e)
        {
            ...
            catch (Exception)  { dataGridView3.DataSource=null; }
        }
    }
    ...
    public class Empresa
    {
        ...
        public void BorrarPersona(Persona pPersona)
        {
            ...
            try
            {
                ...
                // Si posee autos a cada auto hay que pasarle el campo dueño a null
               
                

                foreach(Auto a in la)
                {
                    if (a.RetornaDueno() != null)
                    {
                        if (a.RetornaDueno().DNI == pPersona.DNI) a.CargaDueno(null);
                    }
                }
            }
            catch (Exception ex) { MessageBox.Show(ex.Message); }
